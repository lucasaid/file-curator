...
var genText = function (data, parentComment, CURRENT, totalSize) {
    ...
    var headerContentArray = headerContent.split("\n");
    headerContentArray.unshift(" ");
    headerContentArray.unshift("FULL PATH: " + CURRENT);
    headerContentArray.unshift(" ");
    headerContentArray.unshift("TOTAL SIZE: " + helpers_1.formatSizeUnits(totalSize));
    headerContentArray.unshift(" ");
    headerContentArray.unshift("FILE CREATED: " + dateformat_1.default(new Date(), "yyyy-mm-dd H:MM:ss"));
    headerContentArray.unshift(" ");
    ...
    headerContentArray = headerContentArray.map(function (line) {
        line = "*      " + line;
